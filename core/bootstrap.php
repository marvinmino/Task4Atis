...
use App\Core\App;
use App\Core\Repository\{RepositoryBuilder, Connection,UserRepository,ArticleRepository,RequestRepository,CategoryRepository,CommentRepository};
...
App::bind('commentQuery', new CommentRepository(
    Connection::make(App::get('config')['database'])
));