			...
			<div class="offset-md-1 col-lg-10 " style="background-color:rgba(0, 0, 0, 0.5);border-radius:1.2%; ">
				<div class="row">
					...
					<div class="col-lg-12 text-center card-detail pt-3 pb-5">
                        <p>You need to be verified to continue as a logged in user. Please check your email.</p>
                        <p>If you didn't get the verification link <a href="sendmail" style="color:blue">click here to resend</a> </p>
                        <p>Please relogin after verification</p>
